...
static void IN_Move_TouchScreen_Quake(void)
{
	...
	{
	default:
		VID_TouchscreenArea( 0,   0,   0,  64,  64, "gfx/touch_console.tga"      , 0.0f, NULL, NULL, &buttons[13], K_ENTER, NULL, 0, 0, 0, true);//that's actually enter button, i'm just lazy to change texture XD
		VID_TouchscreenArea( 0,  64,   0,  64,  64, "gfx/touch_menu.tga"         , 0.0f, NULL, NULL, &buttons[14], K_ESCAPE, NULL, 0, 0, 0, true);
        VID_TouchscreenArea( 0,  128,   0,  64,  64, "gfx/touch_save.tga"         , 0.0f, NULL, NULL, &buttons[15], K_F6, NULL, 0, 0, 0, true);
        VID_TouchscreenArea( 0,  192,   0,  64,  64, "gfx/touch_load.tga"         , 0.0f, NULL, NULL, &buttons[16], K_F9, NULL, 0, 0, 0, true);
        VID_TouchscreenArea( 3,  -64,   -320,  64,  64, "gfx/touch_mwheelup.tga"         , 0.0f, NULL, NULL, &buttons[17], K_MWHEELUP, NULL, 0, 0, 0, true);
        //VID_TouchscreenArea( 3,  -128,   -320,  64,  64, "gfx/touch_mwheeldown.tga"    , 0.0f, NULL, NULL, &buttons[18], K_MWHEELDOWN, NULL, 0, 0, 0, true); //engine have some bug with that, MWHEELDOWN bind does nothing
        VID_TouchscreenArea( 0,  256,   0,  64,  64, "gfx/touch_downarrow.tga"         , 0.0f, NULL, NULL, &buttons[19], K_DOWNARROW, NULL, 0, 0, 0, true);
		VID_TouchscreenArea( 2,   0,-256, 256, 256, "gfx/touch_movebutton.tga"   , 0.0f, NULL, move, &buttons[0], K_MOUSE4, NULL, 0, 0, 0, true);
		VID_TouchscreenArea( 3, -256, -256, 256, 256, "gfx/touch_aimbutton.tga"    , 0.0f, NULL, aim,  &buttons[1], K_MOUSE5, NULL, 0, 0, 0, true);
		VID_TouchscreenArea( 3,  -228,-480,  100,  100, "gfx/touch_jumpbutton.tga"   , 0.0f, NULL, NULL, &buttons[3], K_SPACE, NULL, 0, 0, 0, true);
		VID_TouchscreenArea( 3, -128,-480,  128,  128, "gfx/touch_attackbutton.tga" , 0.0f, NULL, NULL, &buttons[2], K_MOUSE1, NULL, 0, 0, 0, true);;
        {
            in_windowmouse_x = x;
            in_windowmouse_y = y;
        }
